...
- CSS
- JavaScript
- [Swiper.js 또는 FontAwesome (필요 시 UI 슬라이더 및 아이콘용 CDN 라이브러리)]
...
- [npm run lint (또는 npx eslint / HTML·CSS Linter)]
- [npm test (또는 단순 로컬 로직 단위 테스트)]
- [npm run build (또는 별도 빌드 도구 없이 정적 파일 유효성 검사)]
